...
\@x{}\moduleLeftDash\@xx{ {\MODULE} RoundRobin}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals}%
\@x{ {\VARIABLES} PC ,\, CHAN ,\, PHONE ,\, ACCESSCOUNT}%
\@x{ {\CONSTANT} NodeCount}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ IDs\@s{65.6} \.{\defeq} 0 \.{\dotdot} NodeCount \.{-} 1}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Channel is instantiated as a boolean, representing either an empty or full
 buffer (containing the token)
 Phone is the shared resource.
 Access Count is used to assert that no more than one process uses the
 \ensuremath{resource(phone)} at once.
\end{cpar}%
\end{lcom}%
 \@x{ TypeInvariant\@s{24.59} \.{\defeq} \.{\land} PC \.{\in} [ IDs
 \.{\rightarrow} 1 \.{\dotdot} 4 ]}%
\@x{\@s{105.40} \.{\land} CHAN \.{\in} [ IDs \.{\rightarrow} {\BOOLEAN} ]}%
\@x{\@s{105.40} \.{\land} PHONE \.{\in} [ IDs \.{\rightarrow} {\BOOLEAN} ]}%
\@x{\@s{105.40} \.{\land} ACCESSCOUNT \.{\in} ( 0 \.{\dotdot} NodeCount )}%
\@x{\@s{105.40} \.{\land} ACCESSCOUNT \.{\leq} 1}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ Init\@s{57.4} \.{\defeq}\@s{4.1} \.{\land} PC \.{=} [ p \.{\in} IDs
 \.{\mapsto} 1 ]}%
 \@x{\@s{97.20} \.{\land} CHAN \.{=} [ [ p\@s{3.43} \.{\in} IDs \.{\mapsto}
 {\FALSE} ] {\EXCEPT} {\bang} [ 0 ] \.{=} {\TRUE} ]}%
\@x{\@s{97.20} \.{\land} PHONE \.{=} [ p \.{\in} IDs \.{\mapsto} {\FALSE} ]}%
\@x{\@s{97.20} \.{\land} ACCESSCOUNT \.{=} 0}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ WaitForToken ( id )\@s{12.29} \.{\defeq} \.{\land} PC [ id ] \.{=} 1}%
\@x{\@s{111.84} \.{\land} CHAN [ id ] \.{=} {\FALSE}}%
 \@x{\@s{111.84} \.{\land} {\UNCHANGED} {\langle} PHONE ,\, CHAN ,\, PC ,\,
 ACCESSCOUNT {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ ReceiveToken ( id )\@s{12.29} \.{\defeq} \.{\land} PC [ id ] \.{=} 1}%
\@x{\@s{107.09} \.{\land} CHAN [ id ] \.{=} {\TRUE}}%
 \@x{\@s{107.09} \.{\land} PC \.{'} \.{=} [ PC {\EXCEPT} {\bang} [ id ] \.{=}
 2 ]}%
 \@x{\@s{107.09} \.{\land} CHAN \.{'} \.{=} [ CHAN {\EXCEPT} {\bang} [ id ]
 \.{=} {\FALSE} ]}%
 \@x{\@s{107.09} \.{\land} {\UNCHANGED} {\langle} PHONE ,\, ACCESSCOUNT
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ PickUpPhone ( id )\@s{16.4} \.{\defeq} \.{\land} PC [ id ] \.{=} 2}%
 \@x{\@s{111.85} \.{\land} PC \.{'} \.{=} [ PC {\EXCEPT} {\bang} [ id ] \.{=}
 3 ]}%
 \@x{\@s{111.85} \.{\land} PHONE \.{'} \.{=} [ PHONE {\EXCEPT} {\bang} [ id ]
 \.{=} {\TRUE} ]}%
\@x{\@s{111.85} \.{\land} ACCESSCOUNT \.{'} \.{=} ACCESSCOUNT \.{+} 1}%
\@x{\@s{111.85} \.{\land} {\UNCHANGED} {\langle} CHAN {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ HangUpPhone ( id )\@s{16.4} \.{\defeq} \.{\land} PC [ id ]\@s{9.94}
 \.{=} 3}%
 \@x{\@s{115.56} \.{\land} PHONE \.{'} \.{=} [ PHONE {\EXCEPT} {\bang} [ id ]
 \.{=} {\FALSE} ]}%
 \@x{\@s{115.56} \.{\land} PC \.{'} \.{=} [ PC {\EXCEPT} {\bang} [ id ] \.{=}
 4 ]}%
\@x{\@s{115.56} \.{\land} ACCESSCOUNT \.{'} \.{=} ACCESSCOUNT \.{-} 1}%
\@x{\@s{115.56} \.{\land} {\UNCHANGED} {\langle} CHAN {\rangle}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Allows for a process to pass along the token, setting its own channel to
 false and the subsequent channel to true
\end{cpar}%
\end{lcom}%
\@x{ SendToken ( id ,\, idNext ) \.{\defeq} \.{\land} PC [ id ] \.{=} 4}%
 \@x{\@s{119.15} \.{\land} CHAN \.{'} \.{=} [ CHAN {\EXCEPT} {\bang} [ id ]
 \.{=} {\FALSE} ,\, {\bang} [ idNext ] \.{=} {\TRUE} ]}%
 \@x{\@s{119.15} \.{\land} PC \.{'} \.{=} [ PC {\EXCEPT} {\bang} [ id ] \.{=}
 1 ]}%
 \@x{\@s{119.15} \.{\land} {\UNCHANGED} {\langle} PHONE ,\, ACCESSCOUNT
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Proc ( n ,\, x )\@s{41.0} \.{\defeq} \.{\lor} WaitForToken ( n )}%
\@x{\@s{106.26} \.{\lor} ReceiveToken ( n )}%
\@x{\@s{106.26} \.{\lor} PickUpPhone ( n )}%
\@x{\@s{106.26} \.{\lor} HangUpPhone ( n )}%
\@x{\@s{106.26} \.{\lor} SendToken ( n ,\, x )}%
\@pvspace{8.0pt}%
 \@x{ Next\@s{66.43} \.{\defeq} \E\, n \.{\in} IDs \.{:} Proc ( n ,\, ( n
 \.{+} 1 ) \.{\%} NodeCount )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Liveness property, securing that if the process counter of a process is 1,
 then eventually the process will receive the token and access the phone
\end{cpar}%
\end{lcom}%
 \@x{ NoStarvation\@s{28.7} \.{\defeq} \A\, n \.{\in} IDs \.{:} {\Box} ( PC [
 n ] \.{=} 1 \.{\leadsto} PHONE [ n ] \.{=} {\TRUE} )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} PC ,\, CHAN
 ,\, PHONE ,\, ACCESSCOUNT {\rangle}} \.{\land} NoStarvation}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 17 09:42:03 \ensuremath{CEST} 2018 by \ensuremath{jensk
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Apr} 16
 12:30:39 \ensuremath{CEST} 2018 by \ensuremath{jensk
}%
\end{cpar}%
\end{lcom}%
\end{document}
