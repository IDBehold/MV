...
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLE} hr ,\, tmp}%
\@x{ TmpData \.{\defeq} ( \.{-} 273 \.{\dotdot} 1000 )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ HCini\@s{1.75} \.{\defeq} \.{\land} hr \.{\in} ( 1 \.{\dotdot} 12 )}%
\@x{\@s{48.00} \.{\land} tmp \.{\in} TmpData}%
\@pvspace{16.0pt}%
 \@x{ HCnxt \.{\defeq} \.{\land} hr \.{'}\@s{4.03} \.{=} {\IF} hr \.{\neq} 12
 \.{\THEN} hr \.{+} 1 \.{\ELSE} 1}%
\@x{\@s{48.00} \.{\land} tmp \.{'} \.{\in} TmpData}%
\@pvspace{16.0pt}%
 \@x{ HC \.{\defeq} HCini \.{\land} {\Box} [ HCnxt ]_{ {\langle} tmp ,\, hr
 {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} HC \.{\implies} {\Box} HCini}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 12 15:44:15 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Feb} 05
 14:25:15 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\end{lcom}%
\end{document}
