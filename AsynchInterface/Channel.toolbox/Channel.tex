...
\@x{ Send ( d ) \.{\defeq} \.{\land} chan . rdy \.{=} chan . ack}%
 ...
 \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
\@x{ Receive\@s{3.33} \.{\defeq} \.{\land} chan . rdy \.{\neq} chan . ack}%
 \@x{\@s{54.79} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, d \.{\in} Data \.{:} Send ( d ) ) \.{\lor}
 Receive}%
\@pvspace{8.0pt}%
\@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ chan}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 12 14:57:15 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Feb} 12
 14:42:22 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\end{lcom}%
\end{document}
