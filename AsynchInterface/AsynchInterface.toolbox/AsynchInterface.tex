...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AsynchInterface}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@x{ {\CONSTANT} Data}%
\@x{ {\VARIABLE} val ,\, rdy ,\, ack}%
\@x{ TypeInvariant \.{\defeq} \.{\land} val\@s{2.08} \.{\in} Data}%
\@x{\@s{80.80} \.{\land} rdy\@s{0.83} \.{\in} \{ 0 ,\, 1 \}}%
\@x{\@s{80.80} \.{\land} ack \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init\@s{5.17} \.{\defeq} \.{\land} val\@s{1.25} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} rdy \.{\in} \{ 0 ,\, 1 \}}%
\@x{\@s{40.87} \.{\land} ack \.{=} rdy}%
\@pvspace{8.0pt}%
\@x{ Send \.{\defeq} \.{\land} rdy\@s{0.83} \.{=} ack}%
\@x{\@s{40.87} \.{\land} val \.{'} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} rdy \.{'} \.{=} 1 \.{-} rdy}%
\@x{\@s{40.87} \.{\land} {\UNCHANGED} ack}%
\@pvspace{8.0pt}%
\@x{ Receive \.{\defeq} \.{\land} rdy\@s{3.63} \.{\neq} ack}%
\@x{\@s{51.46} \.{\land} ack \.{'} \.{=} 1 \.{-} ack}%
\@x{\@s{51.46} \.{\land} {\UNCHANGED} {\langle} val ,\, rdy {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Send \.{\lor} Receive}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} val
 ,\, rdy ,\, ack {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 12 14:41:04 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Feb} 12
 13:50:41 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\end{lcom}%
\end{document}
