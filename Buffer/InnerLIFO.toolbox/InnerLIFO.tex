...
\@x{ {\CONSTANT} Message ,\, BufSize}%
\@x{ {\VARIABLES} in ,\, out ,\, q}%
 \@x{ InChan\@s{6.87} \.{\defeq} {\INSTANCE} Channel {\WITH} Data
 \.{\leftarrow} Message ,\, chan \.{\leftarrow} in}%
...
\@x{}%
\@y{\@s{0}%
 Wraps \ensuremath{Len(s)} operator into a function
}%
\@xx{}%
\@x{ MyLen \.{\defeq} [ s \.{\in} Seq ( Nat ) \.{\mapsto} Len ( s ) ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ inc \.{\defeq} [ i \.{\in} Nat \.{\mapsto} i \.{+} 1 ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ RecursiveLen [ s \.{\in} Seq ( Nat ) ] \.{\defeq} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} 0 \.{\ELSE} 1 \.{+} RecursiveLen [ Tail ( s )
 ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ RecLen \.{\defeq} {\CHOOSE} RecLen \.{:}}%
 \@x{\@s{75.71} RecLen \.{=} [ s \.{\in} Seq ( Nat ) \.{\mapsto} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} 0 \.{\ELSE} 1 \.{+} RecLen [ Tail ( s ) ] ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ fact [ n \.{\in} Nat ] \.{\defeq} {\IF} n \.{=} 0 \.{\THEN} 1 \.{\ELSE}
 n \.{*} fact [ n \.{-} 1 ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Recursive function for finding the \ensuremath{n}\mbox{'}th fibonacci number
}%
\@xx{}%
 \@x{ fib [ n \.{\in} Nat ] \.{\defeq} {\IF} n \.{\leq} 1 \.{\THEN} n
...
\@pvspace{8.0pt}%
 \@x{ TypeInvariant\@s{4.1} \.{\defeq}\@s{4.1} \.{\land} InChan {\bang}
 TypeInvariant}%
\@x{\@s{89.00} \.{\land} OutChan {\bang} TypeInvariant}%
\@x{\@s{89.00} \.{\land} q \.{\in} Seq ( Message )}%
\@x{\@s{89.00} \.{\land} BufSize \.{\in} Nat}%
\@x{\@s{89.00} \.{\land} RecursiveLen [ q ] \.{\leq} BufSize}%
\@pvspace{8.0pt}%
 \@x{ SSend ( msg )\@s{4.1} \.{\defeq}\@s{4.1} \.{\land} InChan {\bang} Send (
 msg )\@s{28.7}}%
\@y{\@s{0}%
 Send \ensuremath{msg} on channel \ensuremath{in} .
}%
\@xx{}%
\@x{\@s{80.22} \.{\land} {\UNCHANGED} {\langle} out ,\, q {\rangle}}%
\@x{\@s{80.22} \.{\land} RecursiveLen [ q ] \.{<} BufSize}%
\@pvspace{8.0pt}%
\@x{ BufRcv \.{\defeq} \.{\land} InChan {\bang} Receive\@s{72.44}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 q\@s{72.97}}%
\@y{\@s{0}%
 insert \ensuremath{val} at the head of \ensuremath{q}.
}%
\@xx{}%
\@x{\@s{51.42} \.{\land} {\UNCHANGED} out}%
\@pvspace{8.0pt}%
\@x{ BufSend \.{\defeq} \.{\land} RecursiveLen [ q ] \.{>} 0\@s{77.9}}%
\@y{\@s{0}%
 Enabled only if \ensuremath{q} is nonempty.
}%
\@xx{}%
\@x{\@s{56.34} \.{\land} OutChan {\bang} Send ( Head ( q ) )\@s{28.7}}%
\@y{\@s{0}%
 Send \ensuremath{Head(q)} on channel \ensuremath{out
}}%
\@xx{}%
\@x{\@s{56.34} \.{\land} q \.{'} \.{=} Tail ( q )\@s{86.15}}%
\@y{\@s{0}%
 and remove it from \ensuremath{q}.
}%
\@xx{}%
\@x{\@s{56.34} \.{\land} {\UNCHANGED} in}%
\@pvspace{8.0pt}%
\@x{ RRcv \.{\defeq} \.{\land} OutChan {\bang} Receive\@s{75.03}}%
\@y{\@s{0}%
 Receive message from channel \ensuremath{out} .
}%
\@xx{}%
\@x{\@s{43.24} \.{\land} {\UNCHANGED} {\langle} in ,\, q {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next\@s{3.41} \.{\defeq} \.{\lor} \E\, msg \.{\in} Message \.{:} SSend (
 msg )}%
\@x{\@s{43.24} \.{\lor} BufRcv}%
\@x{\@s{43.24} \.{\lor} BufSend}%
\@x{\@s{43.24} \.{\lor} RRcv}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{4.87} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} in
 ,\, out ,\, q {\rangle}}}%
\@x{}\midbar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 14 11:56:59 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Feb} 12 14:42:22 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\end{lcom}%
\end{document}
