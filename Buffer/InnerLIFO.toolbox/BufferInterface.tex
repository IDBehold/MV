...
\@x{}\moduleLeftDash\@xx{ {\MODULE} BufferInterface}\moduleRightDash\@xx{}%
\@x{ {\VARIABLE} bufInt}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Send ( \_ ,\, \_ ,\, \_ ,\, \_ ) ,\,}%
\@x{\@s{54.75} Rcv ( \_ ,\, \_ ,\, \_ ) ,\,}%
\@x{\@s{54.75} InitBufInt ,\,}%
\@x{\@s{54.75} Proc ,\,}%
\@x{\@s{54.75} Val}%
\@pvspace{8.0pt}%
 \@x{ {\ASSUME} \A\, p ,\, d ,\, biOld ,\, biNew \.{:} \.{\land} Send ( p ,\,
 d ,\, biOld ,\, biNew ) \.{\in} {\BOOLEAN}}%
\@x{\@s{135.47} \.{\land} Rcv ( p ,\, biOld ,\, biNew ) \.{\in} {\BOOLEAN}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ BReq \.{\defeq} [ op \.{:} \{\@w{Send} \} ,\, val \.{:} Val ] \.{\cup} [
 op \.{:} \{\@w{Rcv} \} ]}%
\@pvspace{8.0pt}%
\@x{ NoVal \.{\defeq} {\CHOOSE} v \.{:} v \.{\notin} Val}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 15 09:41:29 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Mar} 15
 09:27:49 \ensuremath{CET} 2018 by \ensuremath{jacob
}%
\end{cpar}%
\end{lcom}%
\end{document}
