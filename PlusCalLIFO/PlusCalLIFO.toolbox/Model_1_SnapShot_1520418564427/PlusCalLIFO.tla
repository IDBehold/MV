...
--algorithm FIFO {
  ...
  {    
    ...
    bs3:    outchan.val := rval; \*Hack to get value into outchan. Not able to do it in bs2.
          }    
...
br2 == /\ pc["bufrcv"] = "br2"
       ...
       /\ q' = <<inchan'.val>> \o q
       /\ Assert((inchan'.val \in Message), 
                 "Failure of assertion at line 22, column 5 of macro called at line 53, column 13.")
       /\ Assert((inchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 23, column 5 of macro called at line 53, column 13.")
       /\ Assert((inchan'.ack \in {0,1}), 
                 "Failure of assertion at line 24, column 5 of macro called at line 53, column 13.")
       /\ Assert((q' \in Seq(Message)), 
                 "Failure of assertion at line 25, column 5 of macro called at line 53, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 26, column 5 of macro called at line 53, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 27, column 5 of macro called at line 53, column 13.")
       /\ Assert((Len(q') <= QueueSize), 
                 "Failure of assertion at line 28, column 5 of macro called at line 53, column 13.")
...
bs2 == /\ pc["bufsend"] = "bs2"
       ...
       /\ Assert((outchan'.val \in Message), 
                 "Failure of assertion at line 22, column 5 of macro called at line 69, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 23, column 5 of macro called at line 69, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 24, column 5 of macro called at line 69, column 13.")
       /\ Assert((q' \in Seq(Message)), 
                 "Failure of assertion at line 25, column 5 of macro called at line 69, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 26, column 5 of macro called at line 69, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 27, column 5 of macro called at line 69, column 13.")
       /\ Assert((Len(q') <= QueueSize), 
                 "Failure of assertion at line 28, column 5 of macro called at line 69, column 13.")
       /\ Assert((outchan'.rdy # oldrdy'), 
...
rr2 == /\ pc["rrcv"] = "rr2"
       ...
       /\ Assert((outchan'.val \in Message), 
                 "Failure of assertion at line 22, column 5 of macro called at line 87, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 23, column 5 of macro called at line 87, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 24, column 5 of macro called at line 87, column 13.")
       /\ Assert((q \in Seq(Message)), 
                 "Failure of assertion at line 25, column 5 of macro called at line 87, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 26, column 5 of macro called at line 87, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 27, column 5 of macro called at line 87, column 13.")
       /\ Assert((Len(q) <= QueueSize), 
                 "Failure of assertion at line 28, column 5 of macro called at line 87, column 13.")
       /\ Assert((outchan'.ack # oldack'), 
...
\* Last modified Wed Mar 07 11:29:06 CET 2018 by jacob
