...
\****************************************************************************************************************
  ...
  {    
    ...
    bs2:    oldrdy := outchan.rdy;
            outchan.rdy := 1 - outchan.rdy || outchan.val := Head(q);
            q := Tail(q);
...
bs2 == /\ pc["bufsend"] = "bs2"
       ...
       /\ Assert((outchan'.val \in Message), 
                 "Failure of assertion at line 20, column 5 of macro called at line 73, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 21, column 5 of macro called at line 73, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 22, column 5 of macro called at line 73, column 13.")
       /\ Assert((q' \in Seq(Message)), 
                 "Failure of assertion at line 23, column 5 of macro called at line 73, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 24, column 5 of macro called at line 73, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 25, column 5 of macro called at line 73, column 13.")
       /\ Assert((Len(q') <= QueueSize), 
                 "Failure of assertion at line 26, column 5 of macro called at line 73, column 13.")
       /\ Assert((outchan'.rdy # oldrdy'), 
...
rr2 == /\ pc["rrcv"] = "rr2"
       ...
       /\ Assert((outchan'.val \in Message), 
                 "Failure of assertion at line 20, column 5 of macro called at line 92, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 21, column 5 of macro called at line 92, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 22, column 5 of macro called at line 92, column 13.")
       /\ Assert((q \in Seq(Message)), 
                 "Failure of assertion at line 23, column 5 of macro called at line 92, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 24, column 5 of macro called at line 92, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 25, column 5 of macro called at line 92, column 13.")
       /\ Assert((Len(q) <= QueueSize), 
                 "Failure of assertion at line 26, column 5 of macro called at line 92, column 13.")
       /\ Assert((outchan'.ack # oldack'), 
...
\* Last modified Thu Mar 08 10:30:35 CET 2018 by jacob
