...
--algorithm FIFO {
  ...
  {    
    ...
    bs2:    outchan.val := Head(q);
            q := Tail(q);
    bs3:    oldrdy := outchan.rdy;
...
VARIABLES inchan, outchan, q, pc, oldrdy_, oldack_, oldrdy, oldack

vars == << inchan, outchan, q, pc, oldrdy_, oldack_, oldrdy, oldack >>
...
ss0 == /\ pc["ssend"] = "ss0"
       ...
       /\ UNCHANGED << inchan, outchan, q, oldrdy_, oldack_, oldrdy, oldack >>
...
ss2 == /\ pc["ssend"] = "ss2"
       ...
       /\ UNCHANGED << outchan, q, oldack_, oldrdy, oldack >>
...
br2 == /\ pc["bufrcv"] = "br2"
       ...
       /\ UNCHANGED << outchan, oldrdy_, oldrdy, oldack >>
...
bs2 == /\ pc["bufsend"] = "bs2"
       ...
       /\ UNCHANGED << inchan, q, oldrdy_, oldack_, oldack >>

bs3 == /\ pc["bufsend"] = "bs3"
       /\ outchan' = [outchan EXCEPT !.val = Head(q)]
       /\ q' = Tail(q)
       ...
       /\ UNCHANGED << inchan, oldrdy_, oldack_, oldrdy, oldack >>
...
rr2 == /\ pc["rrcv"] = "rr2"
       ...
       /\ Assert((outchan'.val \in Message), 
                 "Failure of assertion at line 22, column 5 of macro called at line 84, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 23, column 5 of macro called at line 84, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 24, column 5 of macro called at line 84, column 13.")
       /\ Assert((q \in Seq(Message)), 
                 "Failure of assertion at line 25, column 5 of macro called at line 84, column 13.")
       /\ Assert((QueueSize > 0), 
                 "Failure of assertion at line 26, column 5 of macro called at line 84, column 13.")
       /\ Assert((QueueSize \in Nat), 
                 "Failure of assertion at line 27, column 5 of macro called at line 84, column 13.")
       /\ Assert((Len(q) <= QueueSize), 
                 "Failure of assertion at line 28, column 5 of macro called at line 84, column 13.")
       /\ Assert((outchan'.ack # oldack'), 
                 "Failure of assertion at line 85, column 13.")
       /\ Assert((outchan'.rdy = outchan'.ack), 
                 "Failure of assertion at line 86, column 13.")
       /\ pc' = [pc EXCEPT !["rrcv"] = "rr0"]
       /\ UNCHANGED << inchan, q, oldrdy_, oldack_, oldrdy >>
...
\* Last modified Wed Mar 07 11:14:07 CET 2018 by jacob
