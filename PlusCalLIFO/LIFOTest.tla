...
\* Process variable oldack of process BufRecv at line 50 col 18 changed to oldack_
CONSTANT defaultInitValue
VARIABLES inchan, outchan, q, pc, oldrdy_, oldack_, oldrdy, oldack, rval

vars == << inchan, outchan, q, pc, oldrdy_, oldack_, oldrdy, oldack, rval >>
...
ss2 == /\ pc["ssend"] = "ss2"
       ...
       /\ Assert((inchan'.val \in valSet), 
                 "Failure of assertion at line 25, column 5 of macro called at line 42, column 13.")
       /\ Assert((inchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 26, column 5 of macro called at line 42, column 13.")
       /\ Assert((inchan'.ack \in {0,1}), 
                 "Failure of assertion at line 27, column 5 of macro called at line 42, column 13.")
       /\ Assert((q \in Seq(valSet)), 
                 "Failure of assertion at line 28, column 5 of macro called at line 42, column 13.")
       ...
       /\ UNCHANGED << outchan, q, oldack_, oldrdy, oldack, rval >>
...
br2 == /\ pc["bufrecv"] = "br2"
       ...
       /\ Assert((inchan'.val \in valSet), 
                 "Failure of assertion at line 25, column 5 of macro called at line 60, column 13.")
       /\ Assert((inchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 26, column 5 of macro called at line 60, column 13.")
       /\ Assert((inchan'.ack \in {0,1}), 
                 "Failure of assertion at line 27, column 5 of macro called at line 60, column 13.")
       /\ Assert((q' \in Seq(valSet)), 
                 "Failure of assertion at line 28, column 5 of macro called at line 60, column 13.")
       ...
       /\ UNCHANGED << outchan, oldrdy_, oldrdy, oldack, rval >>
...
bs2 == /\ pc["bufsend"] = "bs2"
       ...
       /\ Assert((outchan'.val \in valSet), 
                 "Failure of assertion at line 25, column 5 of macro called at line 77, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 26, column 5 of macro called at line 77, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 27, column 5 of macro called at line 77, column 13.")
       /\ Assert((q \in Seq(valSet)), 
                 "Failure of assertion at line 28, column 5 of macro called at line 77, column 13.")
       /\ Assert((outchan'.rdy # oldrdy'), 
                 "Failure of assertion at line 78, column 13.")
       /\ Assert((outchan'.rdy # outchan'.ack), 
                 "Failure of assertion at line 79, column 13.")
       /\ pc' = [pc EXCEPT !["bufsend"] = "bs0"]
       /\ UNCHANGED << inchan, q, oldrdy_, oldack_, oldack, rval >>
...
rr2 == /\ pc["rrecv"] = "rr2"
       ...
       /\ Assert((outchan'.val \in valSet), 
                 "Failure of assertion at line 25, column 5 of macro called at line 96, column 13.")
       /\ Assert((outchan'.rdy \in {0,1}), 
                 "Failure of assertion at line 26, column 5 of macro called at line 96, column 13.")
       /\ Assert((outchan'.ack \in {0,1}), 
                 "Failure of assertion at line 27, column 5 of macro called at line 96, column 13.")
       /\ Assert((q' \in Seq(valSet)), 
                 "Failure of assertion at line 28, column 5 of macro called at line 96, column 13.")
       /\ Assert((outchan'.ack # oldack'), 
                 "Failure of assertion at line 97, column 13.")
       /\ Assert((outchan'.rdy = outchan'.ack), 
                 "Failure of assertion at line 98, column 13.")
       /\ pc' = [pc EXCEPT !["rrecv"] = "rr0"]
       /\ UNCHANGED << inchan, oldrdy_, oldack_, oldrdy >>
