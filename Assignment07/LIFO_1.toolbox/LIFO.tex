...
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} LIFOInterface {\bang} Init \.{\land} {\Box} [ Next ]_{
 {\langle} in ,\, out ,\, lifoq {\rangle}} \.{\land} LIFOInterface {\bang}
 Liveness \.{\land} Liveness1 \.{\land} Liveness2 \.{\land} Liveness3}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
