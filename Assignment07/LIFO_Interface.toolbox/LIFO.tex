...
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} LIFOInterface {\bang} Init}%
 \@x{ TypeInvariant\@s{4.1} \.{\defeq}\@s{4.1} LIFOInterface {\bang}
 TypeInvariant}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{ SSend ( msg )\@s{4.1} \.{\defeq}\@s{4.1} LIFOInterface {\bang} Send (
 msg )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@pvspace{8.0pt}%
\@x{ RRcv \.{\defeq} LIFOInterface {\bang} Rcv}%
\@pvspace{8.0pt}%
