...
\@x{}\moduleLeftDash\@xx{ {\MODULE} LIFO\_Interface}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences}%
\@x{ {\CONSTANT} QueueSize ,\, Message}%
\@x{ {\VARIABLES} q ,\, in ,\, out}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Generalized sender/reciever interface - The \ensuremath{Send} and
 \ensuremath{Rcv} methods and a queue is specified, while specifics about how
 its done is omitted
\end{cpar}%
\end{lcom}%
...
\@pvspace{8.0pt}%
 ...
 TypeInvariant}%
\@x{\@s{45.1} \.{\land} OutChan {\bang} TypeInvariant}%
\@x{\@s{45.1} \.{\land} q \.{\in} Seq ( Message )}%
\@x{\@s{45.1} \.{\land} QueueSize \.{>} 0}%
\@x{\@s{45.1} \.{\land} QueueSize \.{\in} Nat}%
\@x{\@s{45.1} \.{\land} Len ( q ) \.{\leq} QueueSize}%
\@pvspace{8.0pt}%
 \@x{ Send ( msg )\@s{4.1} \.{\defeq}\@s{4.1} \.{\land} InChan {\bang} Send (
 msg )}%
\@y{\@s{0}%
 Send \ensuremath{msg} on channel \ensuremath{in} .
}%
\@xx{}%
\@x{\@s{74.60} \.{\land} {\UNCHANGED} {\langle} out ,\, q {\rangle}}%
\@x{\@s{74.60} \.{\land} Len ( q ) \.{<} QueueSize}%
\@pvspace{8.0pt}%
\@x{ Rcv \.{\defeq} \.{\land} OutChan {\bang} Rcv\@s{53.3}}%
\@y{\@s{0}%
 Receive message from channel \ensuremath{out} .
}%
\@xx{}%
\@x{\@s{35.94} \.{\land} {\UNCHANGED} {\langle} in ,\, q {\rangle}}%
\@pvspace{8.0pt}%
\@x{ INext \.{\defeq} \.{\lor} \E\, msg \.{\in} Message \.{:} Send ( msg )}%
\@x{\@s{43.68} \.{\lor} Rcv}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{Rcv} should eventually be called if \ensuremath{Send(msg)} has
 been enabled
\end{cpar}%
\end{lcom}%
 \@x{ Liveness \.{\defeq} \E\, msg \.{\in} Message \.{:} {\WF}_{ {\langle} in
 ,\, out ,\, q {\rangle}} ( Send ( msg ) \.{\lor} Rcv )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\end{document}
