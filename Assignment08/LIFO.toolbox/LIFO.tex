...
\@x{}\moduleLeftDash\@xx{ {\MODULE} LIFO}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences}%
\@x{ {\CONSTANT} Message ,\, QueueSize}%
\@x{ {\VARIABLES} in ,\, out ,\, lifoq}%
\@pvspace{8.0pt}%
 \@x{ LIFOInterface \.{\defeq} {\INSTANCE} LIFO\_Interface {\WITH} q
 \.{\leftarrow} lifoq}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
\@x{ BufRcv \.{\defeq} \.{\land} LIFOInterface {\bang} InChan {\bang} Rcv}%
 \@x{\@s{51.42} \.{\land} lifoq \.{'} \.{=} {\langle} in . val {\rangle}
 \.{\circ} lifoq}%
\@x{\@s{51.42} \.{\land} {\UNCHANGED} out}%
\@pvspace{8.0pt}%
 \@x{ BufSend \.{\defeq} \.{\land} lifoq \.{\neq} {\langle}
 {\rangle}\@s{176.37}}%
\@y{\@s{0}%
 Enabled only if \ensuremath{q} is nonempty.
}%
\@xx{}%
 \@x{\@s{56.34} \.{\land} LIFOInterface {\bang} OutChan {\bang} Send ( Head (
 lifoq ) )\@s{24.59}}%
\@y{\@s{0}%
 Send \ensuremath{Tail(q)} on channel \ensuremath{out
}}%
\@xx{}%
\@x{\@s{56.34} \.{\land} lifoq \.{'} \.{=} Tail ( lifoq )\@s{136.63}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} LIFOInterface {\bang} INext}%
\@x{\@s{39.83} \.{\lor} BufRcv}%
\@x{\@s{39.83} \.{\lor} BufSend}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{BufRcv} should eventually be called if
 \ensuremath{LIFOInterface{\bang}Send(msg)} has been enabled
\end{cpar}%
\end{lcom}%
 \@x{ Liveness1 \.{\defeq} \E\, msg \.{\in} Message \.{:} {\WF}_{ {\langle} in
 ,\, out ,\, lifoq {\rangle}} ( LIFOInterface {\bang} Send ( msg ) \.{\lor}
 BufRcv )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
While the \ensuremath{lifoq} is NOT empty \ensuremath{BufSend} is enabled
\end{cpar}%
\end{lcom}%
 \@x{ Liveness2 \.{\defeq} {\SF}_{ {\langle} in ,\, out ,\, lifoq {\rangle}} (
 lifoq \.{\neq} {\langle} {\rangle} \.{\lor} BufSend )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{LIFOInterface{\bang}Rcv} should eventually be called if
 \ensuremath{BufSend} has been enabled
\end{cpar}%
\end{lcom}%
 \@x{ Liveness3 \.{\defeq} {\WF}_{ {\langle} in ,\, out ,\, lifoq {\rangle}} (
 BufSend \.{\lor} LIFOInterface {\bang} Rcv )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq} \.{\land} LIFOInterface {\bang} Init}%
 \@x{\@s{38.36} \.{\land} {\Box} [ Next ]_{ {\langle} in ,\, out ,\, lifoq
 {\rangle}}}%
\@x{\@s{38.36} \.{\land} LIFOInterface {\bang} Liveness}%
\@x{\@s{38.36} \.{\land} Liveness1}%
\@x{\@s{38.36} \.{\land} Liveness2}%
\@x{\@s{38.36} \.{\land} Liveness3}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} LIFOInterface {\bang} TypeInvariant}%
\@x{}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\end{document}
